...
function viewWeatherForecastWebApiProject() {
  ...
  projectInfo.innerHTML = `
    ...
    <h3>User Interface</h3>
    <p>
      The UI is a simple HTML page served by the API itself. It uses JavaScript <code>fetch()</code> to request forecast text and inserts it into a
      <code>&lt;pre&gt;</code> element so line breaks and formatting display correctly.
    </p>
...
<h3>User Interface</h3>
<p>
  The UI lives entirely in the console: section titles are surrounded by blank lines, items appear as <code>Name - Description</code>,
  and vegan options get a dedicated “Vegan Options” section generated by LINQ filtering.
  The final line shows the filesystem path to the QR code for quick access.
</p>
